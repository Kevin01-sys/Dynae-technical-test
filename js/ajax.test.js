// obtain API data
        ...
        function validarFormulario(e) {
                ...
                if(Date.parse(endDate) < Date.parse(startDate)) alert("La fecha final debe ser mayor a la fecha inicial");
                if(endHour < startHour) alert("La hora de la fecha final debe ser mayor a la fecha inicial");
                this.submit();
        }
...
document.addEventListener("DOMContentLoaded", function() {
        document.getElementById("formDates").addEventListener('submit', validarFormulario);
});
